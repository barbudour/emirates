...
@import '../assets/styles/mixins.styl'
  ...
  .social
    ...
    //   b vm(117)
    //   l vm(310)
    //   background url("data:image/svg+xml,%3Csvg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 68.5 68.5' xml:space='preserve'%3E%3Cstyle type='text/css'%3E .st0%7Bfill:%23fff;%7D%0A%3C/style%3E%3Cg%3E%3Cpath class='st0' d='M67.1,1.5c-1-1-2.3-1.6-3.7-1.5c-0.3,0-0.7,0.1-1,0.1c-1,0.2-1.8,0.7-2.5,1.4L1.5,59.9c-2,1.9-2,5.1-0.1,7.1 c1,1,2.3,1.6,3.7,1.5c1.3,0,2.5-0.6,3.4-1.5L66.9,8.6C68.9,6.7,69,3.5,67.1,1.5'/%3E%3Cpath class='st0' d='M1.4,1.5c1-1,2.3-1.6,3.7-1.5c0.3,0,0.7,0.1,1,0.1c1,0.2,1.8,0.7,2.5,1.4l58.2,58.4c2,1.9,2,5.1,0.1,7.1 c-1,1-2.3,1.6-3.7,1.5c-1.3,0-2.5-0.6-3.4-1.5L1.5,8.6C-0.5,6.7-0.5,3.5,1.4,1.5'/%3E%3C/g%3E%3C/svg%3E%0A") no-repeat center
    //   size vm(32)
    //   background-size vm(32) vm(32)
    //   z-index 1
    &__share
      w vw(19)
      fill black
